...
<head>
    ...
    <link rel="stylesheet" href="../../../public/css/pagina-login.css">
...
<body class="alllogin" id="login-random">
            ...
            <form action="" class="modal-login">
                ...
                <div class="modal-midlogin">
                    <div class="login-fill">
                        <div class="box">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16" id="mail">
                    ...
                    <div class="login-fill">
                        <div class="box">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16" id="lock">
    ...
    <script type="text/javascript" src="../../../public/js/pagina-login.js"></script>
</body>