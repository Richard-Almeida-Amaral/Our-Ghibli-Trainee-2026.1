...
<?php require('./app/views/admin/modaisPost/postCriar.php') ?>
<?php require('./app/views/admin/modaisPost/postEditar.php') ?>
<?php require('./app/views/admin/modaisPost/postExcluir.php') ?>
<?php require('./app/views/admin/modaisPost/postVisualizar.php') ?>
